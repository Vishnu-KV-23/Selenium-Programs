...
public class BookCabServiceTest {
	...
	public void test11ViewBookingByIdWhenValid() {
		...
		Booking result = serviceObj.viewBookingById("180");
		assertTrue(result != null && result.getBookingId().equalsIgnoreCase("180"));
	}
	...
	public void test12ViewBookingByIdWhenInvalid() {
		// fill code here
		// Create an object for the Booking class using the variable name book
		// Use assertNull assertion to check the book object
		Booking book = serviceObj.viewBookingById("200");
		assertNull(book);
	}
	...
	public void test14ViewBookingByCabTypeForEmptyList() {
		...
		serviceObj.setBookingList(new ArrayList<Booking>());
		List<Booking> booking = serviceObj.viewBookingByCabType("Mini");
