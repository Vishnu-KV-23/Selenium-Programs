...
public class ToolTip {      // DO NOT CHANGE THE CLASS NAME
	...
	public static String testToolTip() throws IOException, InterruptedException
	{
		...
		action.moveToElement(registerLink).perform();

		String tooltipText = registerLink.getAttribute("title");
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		createDriver();
		String result = testToolTip();
		System.out.println("Tooltip Text: " + result);
	}
}
